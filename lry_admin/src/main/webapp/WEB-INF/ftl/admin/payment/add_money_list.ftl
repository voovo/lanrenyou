    ...
    <body>
        <table cellspacing=0 cellpadding=0 width="100%" align=center border=0 >
            <tr height=28>
                <td background=/imgs/admin/title_bg1.jpg style="padding-left:10px;">
                    当前位置: <a href="main.html">管理首页</a> - 资金操作管理 - 入金记录
                </td>
            </tr>
            <tr>
        ...
        <div class="main_content">
            ...
            <div class="main_search">
                <h4>搜索</h4>
                <form id="querytoaudituserform" action="/admin/payment/addmoneylist" >
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="querystatus" id="">
                                ...
                                <option value="110" <#if queryConditionMap?? && queryConditionMap.get('querystatus')==110>selected="selected"</#if>>待银行转账</option>
                                <option value="120" <#if queryConditionMap?? && queryConditionMap.get('querystatus')==120>selected="selected"</#if>>银行转账成功</option>
                                <option value="130" <#if queryConditionMap?? && queryConditionMap.get('querystatus')==130>selected="selected"</#if>>入金成功</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
