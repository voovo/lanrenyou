    ...
    <body>
        <table cellspacing=0 cellpadding=0 width="100%" align=center border=0 >
            <tr height=28>
                <td background=/imgs/admin/title_bg1.jpg style="padding-left:10px;">
                    当前位置: <a href="main.html">管理首页</a> - <a href="yhgl.html">管理员列表</a> - 新增管理员
                </td>
            </tr>
            <tr>
        ...
        <div class="main_content">
            ...
            <div class="main_search">
                <h4>管理员账户信息</h4>
                <form action="/admin/administrator/addsubmit" method="post" id="addAdminForm"/>
                <table width="100%" border="0" cellspacing="2" cellpadding="4">
                    <tr>
                        <td width="100" align="right">用户名：</td>
                        <td><input class="s_input" type="text" name="name"></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <!--
                    <tr>
                        ...
                        <td><input class="s_input" type="text"></td>
                        <td></td>
                        <td></td>
                    </tr>
                     -->
