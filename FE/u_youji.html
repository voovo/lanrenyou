...
<div class="waper_box">
    ...
    <ul id="u_yj_list" class="waper_box">
        <!-- 我的游记列表循环开始 -->
        <li>
            <img class="u_yj_imgDetail" src="imgs/yj_img.jpg" alt="">
            <div class="u_yj_txtDetail">
                <h2><a href="#">【美国66号公路自驾全攻略】翻滚吧，青春！</a></h2>
                <p>旅途就像人生，起先是兴奋不已地做加法，偶后是难以取舍地做减法，而真正开始的过程，是不得不忍痛的被减法和被除法。当然，上帝在关上一扇窗的时候也一定会同时打开一扇门，所以，就一定还有意想不到的被加法甚至被乘法。</p>
            </div>
            <div class="u_yj_info">
                <span class="ico icon_time">2014-05-01</span>
                <span class="ico icon_eye">2308</span>
                <a href="#"><i class="ico icon_edit"></i>编辑</a>
