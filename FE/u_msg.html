...
<head>
    ...
    <!-- 页面自用 -->
    <link rel="stylesheet" href="css/waper.css">
...
<div id="top_nav" class="clearfix">
    ...
    <div id="user" class="right">
        ...
        <ul class="clearfix">
            <li>
                <img src="imgs/user_face.jpg" width="20" height="20" alt="" />
            </li>
    ...
    <ul id="u_msg_list">
        ...
        <li class="unread">
            ...
            <div class="clearfix">
                ...
                <p class="left">2014-06-16</p>
                <p class="right">
                    <a href="javascript:;" class="ico delete_ico">删除</a>
                    <a href="javascript:;" class="ico edit_icon">回复</a>
                </p>
            </div>
            <p class="u_msg_details">你好，我和我的家人想十一去美国玩7天左右，看了你的游记觉得不错，能否帮我们设计一套行程呢，谢谢！</p>
        </li>
        <li class="unread">
            <input type="checkbox" />
            <img src="imgs/user_face.jpg" alt="" />
            <div class="clearfix">
                <p class="left">
                    <span class=""><a href="#">shell_corona</a></span>
                </p>
                <p class="left">2014-06-16</p>
                <p class="right">
                    <a href="javascript:;" class="ico delete_ico">删除</a>
            ...
            <p class="u_msg_details">你好，我和我的家人想十一去美国玩7天左右，看了你的游记觉得不错，能否帮我们设计一套行程呢，谢谢！你好，我和我的家人想十一去美国玩7天左右，看了你的游记觉得不错，能否帮我们设计一套行程呢，谢谢！你好，我和我的家人想十一去美国玩7天左右，看了你的游记觉得不错，能否帮我们设计一套行程呢，谢谢！你好，我和我的家人想十一去美国玩7天左右，看了你的游记觉得不错，能否帮我们设计一套行程呢，谢谢！</p>
        </li>
        <li>
            <input type="checkbox" />
            <img src="imgs/user_face.jpg" alt="" />
...
<div id="footer">
    <div class="box">
        <ul id="min_share" class="clearfix">
            <li class="wx">
        ...
        <p class="copyright">Copyright @lanrenyou. 2014 All Right Reserved.</p>
    </div>
</div>
