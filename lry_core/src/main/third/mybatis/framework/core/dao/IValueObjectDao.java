 ...
 * @param <V>
 */
public interface IValueObjectDao<V extends IValueObject> extends IDao {
	 ...
	 * @return
	 */
	Page pagedQuery(String statement, int pageNo, int pageSize,
	 ...
	 * @return
	 */
	Object findOne(String statement, Object parameter);
	 ...
	 * @return
	 */
	List findList(String statement, Object parameter);
	 ...
	 * @return
	 */
	int doDelete(String statement, Object parameter);
	 ...
	 * @return
	 */
	int doUpdate(String statement, Object parameter);
