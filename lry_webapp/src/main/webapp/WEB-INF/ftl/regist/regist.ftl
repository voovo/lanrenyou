        ...
        <div class="form_table">
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="40%"><input type="text" class="input_220"></td>
                    <td><span class="form_notice">该邮箱作为登录账号</span></td>
                </tr>
                <tr>
                    <td align="right"><span class="ft_14">密码：</span></td>
                    <td><input type="password" class="input_220"></td>
                ...
                <tr>
                    ...
                    <td colspan="2"><input type="text" class="input_70" maxlength="4"> <div id="form_code"><img src="/resources/imgs/code.jpg" alt=""> </div><span id="changeCode">看不清，<a href="javascript:;">换一张</a></span></td>
                </tr>
                <tr>
                    <td></td>
